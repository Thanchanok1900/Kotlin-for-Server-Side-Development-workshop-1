...
class WorkshopTest {
    ...
    fun `test kilometersToMiles with one kilometer`() {
        ...
        assertEquals(expectedMiles, actualMiles, 0.001, "1 km should be 0.621371 M")
    }
    ...
    fun `test calculateTotalElectronicsPriceOver500`() {
        ...
        assertEquals(expectedTotal, actualTotal, 0.001, "Total price of Electronics > 500 should match expected")
    }
    ...
    fun `test countElectronicsOver500`() {
        ...
        assertEquals(expectedCount, actualCount, "Number of Electronics > 500 should be 4")
    }
}
